            ...
            <form action="interests-form" method="POST" class="col-12">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <label for="seeking-group"><strong>Seeking:</strong></label>
                        <div class="form-group form-check pl-0"
                             id="seeking-group">
                            <label for="seeking" class="form-check-label ml-4">
                                <input class="form-check-input" type="radio"
                                       name="seeking" id="seeking" value="female"> Female
                            </label>
                            <label for="seeking" class="form-check-label ml-4">
                                <input class="form-check-input" type="radio"
                                       name="seeking" id="seeking" value="male"> Male
                            </label>
                            <label for="seeking" class="form-check-label ml-4">
                                <input class="form-check-input" type="radio"
                                       name="seeking" id="seeking" value="other"> Other
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-6">
