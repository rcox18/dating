            ...
            <div class="col-sm-6">
                <div class="card">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">State: {{ @SESSION.state }}</li>
                        <li class="list-group-item">Seeking: {{ @SESSION.seeking }}</li>
                        <li class="list-group-item">Interests: {{ @SESSION.interests }}</li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="row">
                    <img src="images/smiley-monster.jpg" class="rounded" alt="smiling monster">
                </div>
                <hr>
                <h3>Biography</h3>
